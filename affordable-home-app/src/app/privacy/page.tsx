    ...
    <>
      ...
      <main style={{ backgroundColor: '#FFFFFF', minHeight: '100vh', padding: 'clamp(48px, 8vw, 80px) clamp(20px, 5vw, 48px)' }}>
        ...
        {[
          ...
          { title: 'No sensitive data stored', body: 'We do not store your income, household size, voucher status, or any other personal details you enter into the wizard. If you choose to provide an email address for results, it is used once to send your results and then discarded.' },
          { title: 'Follow-up survey (only if you ask)', body: 'At the end of the quiz you can tick a box asking us to check in about two months later. Only then do we keep your email address, and only until that single message is sent, at which point it is deleted. The message links to a short, anonymous survey about how your housing search went; your answer is not connected to your email address. If you have an account, we may send you that same one-off survey. We never sell your address or use it for marketing.' },
